        ...
        <div className="flex flex-wrap justify-center gap-12 mb-12">
          <div className="border-4 border-pink-500 p-4 bg-yellow-300 max-w-80">
            <p className="mt-2 text-center text-xl max-w-40">
              "I think tackling the fourth wall so directly is kind of tasteless
              in the modern world." - Entity inside the Polyhedron, Pathologic
            </p>
          </div>
          <div className="border-4 border-cyan-500 p-4 bg-purple-300 max-w-80">
            <p className="mt-2 text-center text-xl">
              "Any choice is right as long as it's willed." - Artemy Burakh,
              Pathologic
            </p>
          </div>
          <div
          ...
          >
            <p className="mt-2 text-center text-xl">
              ...
              FACE! FACE FACEFACEFACEFACE! NOW! BULLETS IN THE FACE! WANT EM!
              NEED EM! GIMMEGIMMEGIMME! AT THE SOUND OF THE BELL IT WILL BE
              FACESHOOTING O'CLOCK! BONGGGGG! KNOCK KNOCK WHO'S THERE SHOOT ME
              IN THE FACE! END OF JOKE! I'M GONNA SING A SONG! SHOOT ME AT THE
              END OF IT! DA DA DA DA DA DA DA! BONG!! ...I NOTICE YOU HAVEN'T
              SHOT ME IN THE FACE! CURIOUS AS TO WHY! Maybe you're weighing the
              moral pros and cons but let me assure you that OH MY GOD SHOOT ME
              IN THE GODDAMNED FACE!! WHAT ARE YOU WAITING FOR!?!?" - Face
              McShooty, Borderlands 2
            </p>
          </div>
