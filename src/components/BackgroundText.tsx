...
export const BackgroundText: React.FC<{ text: string }> = (props) => {
        ...
        >
          <h1
            ...
            style={{
              ...
              paddingRight: '100vw' // Increased to accommodate repeated text
            }}
          >
            {`${props.text.toUpperCase()} `.repeat(5)} {/* Repeat text 5 times with spaces */}
          </h1>
        </div>
      );
    });
